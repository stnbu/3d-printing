...
handle_width = 13.3895 * 2;
height = 230 * 0.439;
foot_width = 16.0235 * 2;
handle_height = 6.585;
food_height = 6.585;
...
module holes() {
    union() {
        quarter_rounded_half_slot(handle_width / 2, handle_height);
        translate([0, height, 0]) quarter_rounded_half_slot(foot_width / 2, food_height);
    }
}
